    ...
    <section id="resources"> 
        ...
        <div id="modules"> 
            ...
            <div class="module"> 
                <h3>Project Name</h3> 
                <ul> 
                    <li><a href="registration.php">Covid Tester<br><br></a></li>
                    <p style="color:#ddd">This project will help to<br>fix the issue for testing<br>the early symptoms of covid<br>and reduce the wastage of<br>covid tester kit</p> 
                </ul> 
            </div> 
            <div class="module"> 
                <h3>Theam Members</h3> 
                <ul> 
                    <li><a href="https://web.facebook.com/protik.mehedihasan">Md. Mehedi Hasan Protik</a></li>
                    ...
                    <li><a href="https://web.facebook.com/nhrupom">Md. Nadir Hossian Rupom</a></li>
            ...
            <div class="module"> 
                <h3>Contact</h3> 
                <ul> 
                    <li class="mail"><a href="mailto: adibarmanshuvro89@gmail.com">Support<br><br></a></li> 
                    <li class="phone"><a href="">01767739907</a></li> 
                </ul> 
            </div> 
            <div class="module"> 
                <h3>Institute</h3>
